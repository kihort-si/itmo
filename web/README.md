...
### [**Лабораторная работа №1**](https://github.com/kihort-si/itmo/tree/main/web/lab1)
...
![JavaScript](https://github.com/kihort-si/itmo/blob/main/common/js.svg) 
...
- При работе с CSS должно быть продемонстрировано использование селекторов потомств, селекторов атрибутов, селекторов идентификаторов, селекторов элементов а также такие свойства стилей CSS, как наследование и каскадирование.
...
![graph](https://github.com/kihort-si/itmo/blob/main/common/web/graph1.svg)

Изменение X: Button {'-2', '-1.5', '-1', '-0.5', '0', '0.5', '1', '1.5', '2'}

Изменение Y: Text {-5...5}

Изменение R: Button {'1', '1.5', '2', '2.5', '3'}

### [**Лабораторная работа №2**](https://github.com/kihort-si/itmo/tree/main/web/lab2)
![Java](https://github.com/kihort-si/itmo/blob/main/common/java.svg)
![CSS](https://github.com/kihort-si/itmo/blob/main/common/css.svg) 
![JavaScript](https://github.com/kihort-si/itmo/blob/main/common/js.svg) 
...
![graph](https://github.com/kihort-si/itmo/blob/main/common/web/graph2.svg)

Изменение X: Button {'-4', '-3', '-2', '-1', '0', '1', '2', '3', '4'}
...
Список результатов сохранять в HTTP-сессии
...
![graph](https://github.com/kihort-si/itmo/blob/main/common/web/graph3.svg)

Изменение X: commandButton {'-5', '-4', '-3', '-2', '-1', '0', '1', '2', '3'}
...
![Angular](https://github.com/kihort-si/itmo/blob/main/common/angular.svg) 
![Java](https://github.com/kihort-si/itmo/blob/main/common/java.svg)
![PostgreSQL](https://github.com/kihort-si/itmo/blob/main/common/postgres.svg)
...
- "Десктопный" - для устройств, ширина экрана которых равна или превышает 1127 пикселей.
- "Планшетный" - для устройств, ширина экрана которых равна или превышает 740, но меньше 1127 пикселей.
...
**Основная страница приложения должна содержать следующие элементы:**
- Набор полей ввода для задания координат точки и радиуса области в соответствии с вариантом задания: Slider (-5 ... 3) для координаты по оси X, Text (-5 ... 3) для координаты по оси Y, и Slider (-5 ... 3) для задания радиуса области. Если поле ввода допускает ввод заведомо некорректных данных (таких, например, как буквы в координатах точки или отрицательный радиус), то приложение должно осуществлять их валидацию.
- Динамически обновляемую картинку, изображающую область на координатной плоскости в соответствии с номером варианта и точки, координаты которых были заданы пользователем. Клик по картинке должен инициировать сценарий, осуществляющий определение координат новой точки и отправку их на сервер для проверки её попадания в область. Цвет точек должен зависить от факта попадания / непопадания в область. Смена радиуса также должна инициировать перерисовку картинки.
- Таблицу со списком результатов предыдущих проверок.
...
![graph](https://github.com/kihort-si/itmo/blob/main/common/web/graph4.svg)