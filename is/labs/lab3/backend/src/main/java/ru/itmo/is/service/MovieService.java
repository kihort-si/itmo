...
public class MovieService {
    ...
    public MovieResponseDto createMovie(MovieRequestDto movieDTO) {
        ...
        Movie existingMovie = movieRepository.findByNameAndStaff(
                movie.getName(),
                movie.getDirector(),
        ...
        if (existingMovie != null) {
            throw new IllegalArgumentException("Фильм с названием '" + movie.getName() +
                    "' и такой съемочной группой уже существует");
        }
    ...
    public MovieResponseDto updateMovie(Integer id, MovieRequestDto movieDTO) {
        ...
        Movie movieWithSameStaff = movieRepository.findByNameAndStaff(
                ...
                updatedMovie.getScreenwriter(),
                updatedMovie.getOperator());
        
        if (movieWithSameStaff != null && movieWithSameStaff.getId() != existingMovie.getId()) {
            throw new IllegalArgumentException("Фильм с названием '" + updatedMovie.getName() +
                    "' и такой съемочной группой уже существует");
        }
